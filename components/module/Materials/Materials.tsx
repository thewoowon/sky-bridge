...
const MATERIALS_DATA: Material[] = [
  {
    ...
    link: 'https://www.megastudy.net/Entinfo/news/news_list.asp#news_view_ax.asp?idx=7234&caty=&cat2=',
    view: 21455,
    type: 'document',
  },
  {
    ...
    link: 'https://www.megastudy.net/Entinfo/news/news_list.asp#news_view_ax.asp?idx=7233&caty=&cat2=&page=1&searchType=&searchWord=',
    view: 8182,
    type: 'strategy',
  },
  {
    title: '사탐으로 메디컬 합격',
    subTitle: '할 수 있을까?',
    link: 'https://www.megastudy.net/Entinfo/news/news_list.asp#news_view_ax.asp?idx=7170&caty=&cat2=',
    view: 29700,
    type: 'discussion',
  },
  {
    ...
    link: 'https://www.megastudy.net/Entinfo/news/news_list.asp#news_view_ax.asp?idx=7209&caty=&cat2=',
    view: 21188,
    type: 'document',
  },
  {
    ...
    link: 'https://www.megastudy.net/Entinfo/news/news_list.asp#news_view_ax.asp?idx=7174&caty=&cat2=',
    view: 24888,
    type: 'strategy',
  },
];
