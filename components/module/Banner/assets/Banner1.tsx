  ...
  return (
    <Container>
      ...
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
      >
        <g opacity="0.7" filter="url(#filter0_f_375_8055)">
          <circle cx="98" cy="80" r="94" fill="url(#paint0_linear_375_8055)" />
        </g>
        <defs>
          <filter
            id="filter0_f_375_8055"
            x="0"
            y="-18"
            width="196"
            height="196"
          ...
          >
            ...
            <feGaussianBlur
              stdDeviation="2"
              result="effect1_foregroundBlur_375_8055"
            />
          </filter>
          <linearGradient
            id="paint0_linear_375_8055"
            x1="201.766"
            y1="-24.3766"
            x2="143.215"
            y2="68.5469"
          ...
          >
            <stop stopColor="#E4FD6F" stopOpacity="0.9" />
            <stop offset="1" stopColor="#E4FD6F" stopOpacity="0" />
          </linearGradient>
        </defs>
      </svg>
    </Container>
...
const Container = styled.div`
  ...
  height: 155px;
  overflow: hidden;
  background: linear-gradient(45deg, #8AA1F1 100%, #6178c8 100%);
  position: relative;
  border-radius: 12px;
